                            ...
                            <div class="col-md-12">
                                <ul id="haru-shop-filter-menu" class="haru-shop-filter-menu">
                                    ...
                                    <li class="haru-shop-categories-btn-wrap" data-panel="cat">
                                        <a href="#categories" class="invert-color"><?php echo esc_html__( 'Categories', 'haru-circle' ); ?></a>
                                    </li>
                                    <?php endif; ?>
                                    <?php if ( haru_get_option('haru_ajax_show_filters') ) : ?>
                                        <li class="haru-ajax-filter" data-panel="filter">
                                            <a href="#filter" class="invert-color"><?php echo esc_html__( 'Filter', 'haru-circle' ); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if ( haru_get_option('haru_ajax_show_search') ) : ?>
                                        <li class="haru-shop-search-btn-wrap haru-ajax-search" data-panel="search">
                                            ...
                                            <a href="#search" id="haru-shop-search-btn" class="invert-color">
                                                <span><?php echo esc_html__( 'Search', 'haru-circle' ); ?></span>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="haru-shop-search" class="haru-shop-search">
                                    <div class="haru-shop-search-input-wrap">
                                        <a href="#" id="haru-shop-search-close"><i class="ion-ios-close"></i></a>
                                        <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url('/') ); ?>">
                                            <input type="text" id="haru-shop-search-input" autocomplete="off" value="" name="s" placeholder="<?php echo esc_attr__( 'Search Products', 'haru-circle' ); ?>" />
                                            <input type="hidden" name="post_type" value="product" />
                                        </form>
                                    </div>

                                    <div id="haru-shop-search-notice"><span><?php printf( esc_html__( 'press %sEnter%s to search', 'haru-circle' ), '<u>', '</u>' ); ?></span></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    ...
                    <?php if ( have_posts() ) : ?>
                        ...
                        <div class="haru-loadmore-wrapper">
                            ...
                            <div class="haru-loadmore-controls">
                                <a href="#" class="haru-loadmore-btn"><i class="fa fa-spinner fa-spin"></i><?php echo esc_html__( 'Load More', 'haru-circle' ); ?></a>
                                
                                <p class="haru-loadmore-all"><?php echo esc_html__( 'All products loaded.', 'haru-circle' ); ?></p>
                            </div>
                        </div>
