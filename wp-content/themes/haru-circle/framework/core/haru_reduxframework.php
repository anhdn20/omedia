...
if (file_exists( WP_PLUGIN_DIR.'/haru-circle-core/includes/redux-extensions/loader.php')) {
    require_once WP_PLUGIN_DIR.'/haru-circle-core/includes/redux-extensions/loader.php';
}
