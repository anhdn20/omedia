...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if ( ! empty( $item->_invalid ) ) {
            ...
            $title = sprintf( esc_html__( '%s (Invalid)','haru-circle' ), $item->title );
        } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
            $classes[] = 'pending';
            /* translators: %s: title of menu item in draft status */
            $title = sprintf( esc_html__('%s (Pending)','haru-circle'), $item->title );
        }
                ...
                <dt class="menu-item-handle">
                    ...
                    <span class="item-controls">
                        ...
                        <span class="item-order hide-if-js">
                            ...
                            ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up','haru-circle'); ?>">&#8593;</abbr></a>
                            |
                            <a href="<?php
                                echo wp_nonce_url(
                            ...
                            ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down','haru-circle'); ?>">&#8595;</abbr></a>
                        </span>
                        <a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item','haru-circle'); ?>" href="<?php
                        ...
                        ?>"><?php esc_html_e( 'Edit Menu Item','haru-circle' ); ?></a>
                    </span>
                </dt>
            </dl>
            ...
            <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
                <?php if( 'custom' == $item->type ) : ?>
                    <p class="field-url description description-wide">
                        <label for="edit-menu-item-url-<?php echo esc_attr($item_id); ?>">
                            <?php esc_html_e( 'URL','haru-circle' ); ?><br />
                ...
                <p class="description description-thin">
                    <label for="edit-menu-item-title-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Navigation Label','haru-circle' ); ?><br />
                        <input type="text" id="edit-menu-item-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                    </label>
                </p>
                <p class="description description-thin">
                    <label for="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Title Attribute','haru-circle' ); ?><br />
                ...
                <p class="field-link-target description">
                    <label for="edit-menu-item-target-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Open link in a new window/tab','haru-circle' ); ?>
                    </label>
                </p>
                <p class="field-css-classes description description-thin">
                    <label for="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'CSS Classes (optional)','haru-circle' ); ?><br />
                        <input type="text" id="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                    </label>
                </p>
                <p class="field-xfn description description-thin">
                    <label for="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Link Relationship (XFN)','haru-circle' ); ?><br />
                        <input type="text" id="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                    </label>
                </p>
                <p class="field-description description description-wide">
                    <label for="edit-menu-item-description-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Description','haru-circle' ); ?><br />
                        <textarea id="edit-menu-item-description-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo esc_attr($item_id); ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
                        <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.','haru-circle'); ?></span>
                    </label>
                </p>        
                <?php
                ...
                <p class="description description-thin">
                    <label for="menu-item-megamenu_sublabel-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Sub Label', 'haru-circle' ); ?><br />
                ...
                <p class="description description-thin sublabel-color">
                    <label for="menu-item-megamenu_sublabel_color-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Sub Label Color', 'haru-circle' ); ?><br />
                ...
                <div class="haru-mega-menu-icon">
                    <label for="edit-menu-item-megamenu_icon-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Icon','haru-circle' ); ?></label>
                    <div class="haru-icon">
                        <span class="icon">
                        ...
                        <div class="mega-entry list-entry-<?php echo esc_attr($item_id); ?>"  data-id="<?php echo esc_attr($item_id); ?>">
                            <span class="megamenu-search">
                                <input type="text" class="box-search search-<?php echo esc_attr($item_id); ?>" placeholder="<?php esc_html_e( 'Ex: balance-scale', 'haru-circle' ); ?>" />
                        ...
                        <div class="mega-entry box-set color-<?php echo esc_attr($item_id); ?>">
                            ...
                            <div class="size">
                                <label for="edit-menu-item-megamenu_icon_size-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Size', 'haru-circle' ); ?></label>
                            ...
                            <div>
                                <label for="edit-menu-item-megamenu_icon_alignment-<?php echo esc_attr($item_id); ?>"><?php esc_html_e( 'Icon Alignment', 'haru-circle' ); ?></label>
                                <select class="select_alignment" id="edit-menu-item-megamenu_icon_alignment-<?php echo esc_attr($item_id); ?>" name="menu-item-megamenu_icon_alignment[<?php echo esc_attr($item_id); ?>]">
                                    <option value="left"<?php selected( $item->megamenu_icon_alignment, 'left' ); ?>><?php esc_html_e( 'Left', 'haru-circle' ); ?></option>
                                    <option value="right"<?php selected( $item->megamenu_icon_alignment, 'right' ); ?>><?php esc_html_e( 'Right', 'haru-circle' ); ?></option>
                                    <option value="center"<?php selected( $item->megamenu_icon_alignment, 'center' ); ?>><?php esc_html_e( 'Center', 'haru-circle' ); ?></option>
                                </select>
                            </div>
                ...
                <p class="megamenu-status description description-wide" style="margin-top: 10px;">
                    ...
                    <?php esc_html_e( 'Enable megamenu','haru-circle' );    ?>
                    </label>
                </p>
                ...
                <p class="megamenu-style description description-wide enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <?php esc_html_e( 'Megamenu style', 'haru-circle' ); ?>
                    <br/>
                    <select id="menu-item-megamenu_style-<?php echo esc_attr($item->ID); ?>" name="menu-item-megamenu_style[<?php echo esc_attr($item->ID); ?>]" class="widefat code edit-menu-item-custom">
                        <option <?php selected( $item->megamenu_style, 'menu_style_column' ); ?> value="menu_style_column"><?php esc_html_e( 'Column', 'haru-circle' ); ?></option>
                        <option <?php selected( $item->megamenu_style, 'menu_style_tab' ); ?> value="menu_style_tab"><?php esc_html_e( 'Tab', 'haru-circle' ); ?></option>
                    </select>
                </p>
                ...
                <p class="megamenu-columns description description-wide megamenu-child-options enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    <label for="menu-item-megamenu_columns-<?php echo esc_attr($item->ID); ?>">
                        <?php esc_html_e( 'Megamenu columns', 'haru-circle' ); ?>
                        <br/>
                        <select id="menu-item-megamenu_columns-<?php echo esc_attr($item->ID); ?>" name="menu-item-megamenu_columns[<?php echo esc_attr($item->ID); ?>]" class="widefat code edit-menu-item-custom">
                            <option <?php selected( $item->megamenu_col, 'columns-2' ) ?> value="columns-2"><?php esc_html_e( 'Two', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col, 'columns-3' ) ?> value="columns-3"><?php esc_html_e( 'Three', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col, 'columns-4' ) ?> value="columns-4"><?php esc_html_e( 'Four', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col, 'columns-5' ) ?> value="columns-5"><?php esc_html_e( 'Five', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col, 'columns-6' ) ?> value="columns-6"><?php esc_html_e( 'Six', 'haru-circle' ) ?></option>
                        </select>
                    </label>
                </p>    
                ...
                <p class="megamenu-background-image description description-wide megamenu-child-options enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    <label for="menu-item-megamenu_background_image-<?php echo esc_attr($item->ID); ?>">
                        <?php esc_html_e( 'Background Image', 'haru-circle' ); ?>
                        <br/>
                ...
                <p class="haru-mega-menu-width description description-wide enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <?php esc_html_e( 'Sub menu fullwidth? (only use with Column style)','haru-circle' );    ?>
                    </label>
                </p>
                ...
                <p class="haru-mega-menu-heading description description-wide enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <?php esc_html_e( 'Hide Mega menu heading?','haru-circle' );    ?>
                    </label>
                </p>
                ...
                <p class="haru-mega-menu-widgetarea description description-wide enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    <label for="edit-menu-item-megamenu_widgetarea-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Mega Menu Widget Area', 'haru-circle' ); ?>
                        <select id="edit-menu-item-megamenu_widgetarea-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-megamenu_widgetarea[<?php echo esc_attr($item_id); ?>]">
                            <option value="0"><?php esc_html_e( 'Select Widget Area', 'haru-circle' ); ?></option>
                            <?php
                ...
                <p class="megamenu-columns-tab description description-wide megamenu-child-options enable_megamenu_child-<?php echo esc_attr( $item_id ); ?>">
                    <label for="menu-item-megamenu_columns_tab-<?php echo esc_attr($item->ID); ?>">
                        <?php esc_html_e( 'Tab columns (only use with tab style)', 'haru-circle' ); ?>
                        <br/>
                        <select id="menu-item-megamenu_columns_tab-<?php echo esc_attr($item->ID); ?>" name="menu-item-megamenu_columns_tab[<?php echo esc_attr($item->ID); ?>]" class="widefat code edit-menu-item-custom">
                            <option <?php selected( $item->megamenu_col_tab, 'columns-1' ) ?> value="columns-1"><?php esc_html_e( 'One', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col_tab, 'columns-2' ) ?> value="columns-2"><?php esc_html_e( 'Two', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col_tab, 'columns-3' ) ?> value="columns-3"><?php esc_html_e( 'Three', 'haru-circle' ) ?></option>
                            <option <?php selected( $item->megamenu_col_tab, 'columns-4' ) ?> value="columns-4"><?php esc_html_e( 'Four', 'haru-circle' ) ?></option>
                        </select>
                    </label>
                </p>
                 <script type="text/javascript">
                ...
                <div class="menu-item-actions description-wide submitbox">
                    <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                        <p class="link-to-original">
                            <?php printf( esc_html__('Original: %s','haru-circle'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                        </p>
                    <?php endif; ?>
                    ...
                    ); ?>"><?php esc_html_e('Remove','haru-circle'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                        ?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel','haru-circle'); ?></a>
                </div>
