...
if ( !in_array($archive_layout, array('full','container')) ) {
    $archive_layout = haru_get_option('archive_layout');
}
// Set Default
...
if( !in_array($archive_sidebar, array('none','left','right')) ) {
    $archive_sidebar = haru_get_option('archive_sidebar');
}
// Set Default
...
$archive_left_sidebar  = haru_get_option('archive_left_sidebar');
$archive_right_sidebar = haru_get_option('archive_right_sidebar');
// Set Default
...
if ( !in_array($archive_paging_style, array('default','load-more','infinity-scroll')) ) {
    $archive_paging_style = haru_get_option('archive_paging_style');
}
// Set Default
