...
if ($enable_header_customize == '1') {
    $header_social_profile = get_post_meta( get_the_ID(), 'haru_' . 'header_customize_right_social_profile', false );
} else {
    if ( haru_get_option('option-header-customize-right') == '1' ) {
        $header_social_profile = haru_get_option('header_customize_right_social_profile');
    } else {
        return;
    }
}
