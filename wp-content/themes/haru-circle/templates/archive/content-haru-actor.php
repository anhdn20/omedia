...
$post_classes[] = haru_get_option('archive_actor_display_type');
...
$post_excerpt = haru_get_option('archive_actor_number_exceprt');
        ...
        <div class="post-content-wrapper">
            <div class="post-detail">
                <div class="post-meta-category">
                    <?php echo get_the_term_list( get_the_ID(), 'actor_category', '', ', ' ); ?>
                </div>
                <h3 class="post-title">
