...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="post-wrapper">
        <?php 
            ...
            $director_info              = get_post_meta( get_the_ID(), 'haru_director' . '_info', true );
            $director_award             = get_post_meta( get_the_ID(), 'haru_director' . '_award', true );
            $director_social            = get_post_meta( get_the_ID(), 'haru_director' . '_social', true );
            $director_film              = get_post_meta( get_the_ID(), 'haru_director' . '_film', true );
            $director_video             = get_post_meta( get_the_ID(), 'haru_director' . '_video', false );
            
            $director_gallery_title     = get_post_meta( get_the_ID(), 'haru_director' . '_gallery_title', true );
            $director_gallery_sub_title = get_post_meta( get_the_ID(), 'haru_director' . '_gallery_sub_title', true );
            $director_gallery_images    = get_post_meta( get_the_ID(), 'haru_director' . '_gallery_images', false ); // Array
            
            $director_crew_link         = get_post_meta( get_the_ID(), 'haru_director' . '_crew_link', true );
            $director_hire_link         = get_post_meta( get_the_ID(), 'haru_director' . '_hire_link', true );
        ...
        <div class="single-director-top">
            <div class="container">
                <div class="director-meta">
                    <span class="director-views"><i class="ion-ios-eye"></i><?php echo haru_count_post_views( get_the_ID() ); ?></span>
                    ...
                    <?php endif; ?>
                    <span class="director-category"><i class="ion-ios-folder"></i><?php echo get_the_term_list( get_the_ID(), 'director_category', '', ', ' ); ?></span>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <div class="director-heading">
                                <h3 class="director-title"><?php the_title(); ?></h3>
                            </div>
                            <div class="director-information">
                                <?php foreach( $director_info as $info ) : ?>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <div class="director-award">
                                ...
                                <ul class="award-list">
                                    <?php foreach( $director_award as $award ) : ?>
                            ...
                            <div class="director-film">
                                ...
                                <ul class="film-list">
                                    <?php foreach( $director_film as $film ) : ?>
                        ...
                        <div class="col-md-8 col-sm-8 director-description">
                            <div class="description-detail">
                                <div class="director-story">
                                    <h3 class="description-title"><?php echo esc_html__( 'Director Story', 'haru-circle' ); ?></h3>
                                    <?php the_content(); ?>
                                </div>
                            </div>
        ...
        <!-- SINGLE ACTOR BOTTOM -->
        <?php if ( isset($director_gallery_images) && !empty($director_gallery_images) ) : ?>
        <div class="single-director-bottom">
            <div class="container">
                <div class="gallery-heading">
                    <h3 class="gallery-title"><?php echo esc_html( $director_gallery_title ); ?></h3>
                    <div class="gallery-sub-title"><?php echo esc_html( $director_gallery_sub_title ); ?></div>
                </div>
            </div>
            <div class="director-gallery">
                <div class="container">
                    <div class="director-images clearfix">
                        <?php 
                        foreach( $director_gallery_images as $director_gallery_image ) : 
                            $image_src = wp_get_attachment_url( $director_gallery_image );
                        ?>
                        <div class="image-item">
                            <img src="<?php echo esc_url($image_src); ?>" alt="<?php echo esc_attr( $director_gallery_title ); ?>">
        ...
        <?php
            $args = array(
                'post__in'       => $director_video,
                'posts_per_page' => -1,
                'orderby'        => 'rand',
                'post_type'      => 'haru_video',
                'post_status'    => 'publish',
            );
            $related_directors         = new WP_Query( $args );
        ?>
        <?php if ( isset($director_video) && !empty($director_video) ) : ?>
        <div class="single-director-video">
            <div class="container">
                ...
                >
                    <?php 
                        if ( $related_directors->have_posts() ) :
                            while ( $related_directors->have_posts() ) : $related_directors->the_post();
                    ?>
