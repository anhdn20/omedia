...
if ( !in_array($archive_layout, array('full','container')) ) {
    $archive_layout = haru_get_option('archive_video_layout');
}
// Set Default
...
if( !in_array($archive_sidebar, array('none','left','right')) ) {
    $archive_sidebar = haru_get_option('archive_video_sidebar');
}
// Set Default
...
$archive_left_sidebar  = haru_get_option('archive_video_left_sidebar');
$archive_right_sidebar = haru_get_option('archive_video_right_sidebar');
// Set Default
...
if ( !in_array($archive_paging_style, array('default','load-more','infinity-scroll')) ) {
    $archive_paging_style = haru_get_option('archive_video_paging_style');
}
// Set Default
                            ...
                            <?php
                                if ( have_posts() ) :
                                    ...
                                    while ( have_posts() ) : the_post();
                                         ...
                                         */
                                        get_template_part( 'templates/archive/content' , 'haru-video' );
                                    endwhile;
                                else :
