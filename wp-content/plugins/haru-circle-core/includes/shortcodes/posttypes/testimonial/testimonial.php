...
if ( ! class_exists('Haru_Framework_Shortcode_Testimonial') ) {
    class Haru_Framework_Shortcode_Testimonial {
        ...
        function haru_testimonial_shortcode($atts) {
            ...
            $layout_type = $data_source = $category = $testimonial_ids = $orderby = $order = $autoplay = $slide_duration = $el_class = $haru_animation = $css_animation = $duration = $delay = $styles_animation = '';
        ...
        function haru_testimonial_vc_map() {
            vc_map(
                array(
                    'name'        => esc_html__( 'Haru Testimonial', 'haru-circle' ),
                    'base'        => 'haru_testimonial',
                    'icon'        => 'fa fa-comments haru-vc-icon',
                    'description' => esc_html__( 'Display client testimonials', 'haru-circle' ),
                    ...
                    'params'      => array(
                        array(
                            ...
                            'value'      => array(
                                ...
                                esc_html__( 'Carousel 2', 'haru-circle' )   => 'carousel_2',
                                esc_html__( 'Carousel 3', 'haru-circle' )   => 'carousel_3',
                            ),
                        ),
                        array(
                            ...
                            'value'       => array(
                                ...
                                esc_html__( 'From Testimonial IDs', 'haru-circle' ) => 'list_id'
                            )
                        ),
                        array(
                            'param_name'  => 'category',
                            'type'        => 'haru_testimonial_categories',
                            'heading'     => esc_html__( 'Testimonial Category', 'haru-circle' ),
                            'admin_label' => true,
                            'dependency'  => array(
                                'element' => 'data_source', 
                                'value'   => array('')
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Select Testimonial', 'haru-circle' ),
                            'dependency' => array(
                                'element' => 'data_source', 
                                'value'   => array('list_id')
                            )
