...
if ( ! class_exists('Haru_Framework_Shortcode_Film_Slideshow') ) {
    class Haru_Framework_Shortcode_Film_Slideshow {
        function __construct() {
            add_shortcode('haru_film_slideshow', array($this, 'haru_film_slideshow_shortcode' ));
            add_action( 'vc_before_init', array($this, 'haru_film_slideshow_vc_map') );
            $this->haru_includes();
        }
        ...
        function haru_film_slideshow_shortcode($atts) {
            $atts        = vc_map_get_attributes( 'haru_film_slideshow', $atts );
            $data_source = $category = $film_ids = $layout_type = $columns = $film_style = $posts_per_page = $autoplay = $slide_duration = $orderby = $order = $el_class = $haru_animation = $css_animation = $duration = $delay = $styles_animation = '';
        ...
        function haru_film_slideshow_vc_map() {
            vc_map(
                array(
                    'base'        => 'haru_film_slideshow',
                    'name'        => esc_html__( 'Haru Film Slideshow', 'haru-circle' ),
                    'icon'        => 'fa fa-user-secret haru-vc-icon',
                    'description' => esc_html__( 'Display our films as slideshow', 'haru-circle' ),
                    ...
                    'params'      => array(
                        ...
                        array(
                            ...
                            'group'       => esc_html__( 'Slide Settings', 'haru-circle' ), 
                        ),
                        array(
    ...
    new Haru_Framework_Shortcode_Film_Slideshow();
}