...
<html <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <script src="<?php echo plugins_url(). '/haru-circle-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.knob.min.js'; ?>"></script>
        <script src="<?php echo plugins_url(). '/haru-circle-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.ba-throttle-debounce.min.js'; ?>"></script>
        <script src="<?php echo plugins_url(). '/haru-circle-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.redcountdown.js'; ?>"></script>
    </head>
            ...
            <div class="maintanence-page">
                <div class="container">
                    <div class="maintenance-title">
                        <h2><?php echo esc_html( haru_get_option('maintenance_title') ); ?></h2>
                    </div>
