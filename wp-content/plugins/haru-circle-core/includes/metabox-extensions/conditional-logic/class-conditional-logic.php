...
class Haru_MB_Conditional_Logic {
    ...
    public function enqueue( $hook ) {
        ...
        wp_register_script( 'conditional-logic', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/conditional-logic/assets/js/conditional-logic.js', array(), '1.0.0', true );
