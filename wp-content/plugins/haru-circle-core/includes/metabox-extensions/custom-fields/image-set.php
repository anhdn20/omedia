...
if ( ! class_exists( 'RWMB_Image_Set_Field' ) ) {
    class RWMB_Image_Set_Field extends RWMB_Field {
        static function admin_enqueue_scripts() {
            wp_enqueue_style( 'rwmb-image-set', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/css/image-set.css', array() );
            wp_enqueue_script( 'rwmb-image-set', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/js/image-set.js', array() );
        }
        /**
         * Get field HTML
         *
