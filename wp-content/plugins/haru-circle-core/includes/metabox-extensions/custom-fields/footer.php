...
if ( class_exists( 'RWMB_Field' ) && !class_exists( 'RWMB_Footer_Field' ) ) {
    class RWMB_Footer_Field extends RWMB_Field {
        ...
        static function admin_enqueue_scripts() {
            wp_register_style( 'rwmb-footer', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/css/footer.css', array(), '3.2', true );
            wp_enqueue_style('rwmb-footer');

            wp_register_script( 'rwmb-footer', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/js/footer.js', array(), '3.2', true );
        ...
        static function options_html( $field, $meta ) { 
            ...
            $html = '';
            $html .= '<option value="">'. esc_html__( 'Default', 'haru-circle' ) .'</option>';
