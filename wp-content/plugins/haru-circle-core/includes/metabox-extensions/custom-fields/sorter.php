...
if ( ! class_exists( 'RWMB_Sorter_Field' ) ) {
    class RWMB_Sorter_Field extends RWMB_Field {
        static function admin_enqueue_scripts() {
            wp_enqueue_style( 'rwmb-sorter', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/css/sorter.css', array() );
            wp_enqueue_script( 'rwmb-sorter', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/js/sorter.js', array() );
        }
        /**
         * Get field HTML
         *
