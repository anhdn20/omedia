...
if ( ! class_exists( 'RWMB_Checkbox_Advanced_Field' ) ) {
    class RWMB_Checkbox_Advanced_Field extends RWMB_Input_Field {
        ...
        static function admin_enqueue_scripts() {
            wp_enqueue_style( 'rwmb-checkbox-advanced', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/css/checkbox-advanced.css', array() );
        }
        ...
        static function the_value( $field, $args = array(), $post_id = null ) {
            ...
            return $value ? esc_html__( 'Yes', 'haru-circle' ) : esc_html__( 'No', 'haru-circle' );
        }
    }
}