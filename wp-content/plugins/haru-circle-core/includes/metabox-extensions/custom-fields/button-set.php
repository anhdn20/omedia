...
if ( ! class_exists( 'RWMB_Button_Set_Field' ) ) {
    class RWMB_Button_Set_Field extends RWMB_Field {
        static function admin_enqueue_scripts() {
            wp_enqueue_style( 'rwmb-button-set', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/css/button-set.css', array() );
            wp_enqueue_script( 'rwmb-button-set', PLUGIN_HARU_CIRCLE_CORE_URL . '/includes/metabox-extensions/custom-fields/assets/js/button-set.js', array() );
        }
        /**
         * Get field HTML
         *
