...
if ( class_exists( 'Haru_Circle_Film_Cat_List_Walker', false ) ) {
    return;
}
 ...
 */
class Haru_Circle_Film_Cat_List_Walker extends Walker {
     ...
     * @var string
     */
    public $tree_type = 'film_category';
    ...
    public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
        ...
        $output .= '"><a href="' . get_term_link( $cat_id, $this->tree_type ) . '">' . apply_filters( 'list_film_cats', $cat->name, $cat ) . '</a>';
