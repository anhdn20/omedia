	...
	if ( ! class_exists( 'Haru_Term_Meta_Install' ) ):
		...
		final class Haru_Term_Meta_Install {
			...
			public function __construct() {
				...
				// Setup plugin
				$this->file     = PLUGIN_HARU_CIRCLE_CORE_FILE;
				$this->url      = PLUGIN_HARU_CIRCLE_CORE_URL;
				$this->path     = PLUGIN_HARU_CIRCLE_CORE_DIR;
				$this->basename = PLUGIN_HARU_CIRCLE_CORE_NAME;
				$this->db       = $wpdb;
