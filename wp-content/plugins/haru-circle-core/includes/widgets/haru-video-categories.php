...
class Haru_Video_Categories_Widget extends Haru_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = esc_html__( 'Widget display video categories.', 'haru-circle' );
        $this->widget_id          = 'haru_widget_video_categories';
        $this->widget_name        = esc_html__( 'Haru Video Categories', 'haru-circle' );
        $this->cached             = false;
        $this->settings = array(
            'title'         => array(
                'type'  => 'text',
            ...
            'count'         => array(
                'type'  => 'checkbox',
                'std'   => 0,
                'label' => esc_html__( 'Show video counts', 'haru-circle' )
            ),
            'hierarchical'      => array(
                'type'  => 'checkbox',
                'std'   => 0,
    ...
    public function widget( $args, $instance ) {
        ...
        include_once PLUGIN_HARU_CIRCLE_CORE_DIR . '/includes/circle/class-video-cat-list-walker.php';

        $list_args['walker']                     = new Haru_Circle_Cat_List_Walker();
        $list_args['title_li']                   = '';
        $list_args['pad_counts']                 = 1;
        $list_args['show_option_none']           = esc_html__( 'No video categories exist.', 'haru-circle' );
