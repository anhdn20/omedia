    ...
    class ReduxFramework_footer extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'haru-circle' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'haru-circle' ) . '</strong>';
            }
        } //function
