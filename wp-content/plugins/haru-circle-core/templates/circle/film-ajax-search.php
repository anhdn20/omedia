...
<div class="film-list columns-<?php echo esc_attr( $_columns ); ?>">
...
<!-- Pagination -->
<?php if ( ( $filmSearchQuery->max_num_pages > 1 ) ) : ?>
    <div class="film-search-form-shortcode-paging-wrapper paging-load-more-ajax">
        <button 
            data-href="" 
            type="button" 
            data-loading-text="<span class='fa fa-spinner fa-spin'></span> Loading..." 
            data-input="<?php echo esc_attr( $_s ); ?>"
            data-category="<?php echo esc_attr( $_category ); ?>"
            data-country="<?php echo esc_attr( $_country ); ?>"
            data-year="<?php echo esc_attr( $_year ); ?>"
            data-sort="<?php echo esc_attr( $_sort ); ?>"
            data-columns="<?php echo esc_attr( $_columns ); ?>"
            data-film_style="<?php echo esc_attr( $_film_style ); ?>"
            data-paging_style="<?php echo esc_attr( $_paging_style ); ?>"
            data-per_page="<?php echo esc_attr( $_per_page ); ?>"
            data-current_page="1"
            class="film-load-more-ajax">
        View More               
        </button>
    </div>
<?php endif; ?>
